...
function calculate_data(presupplied_data) {
  ...
  data.forEach(function (value) {
    ...
    if (value.waar_was_ik == null) {
      0
    } else {
      (freq_waar_was_ik[value.waar_was_ik] == undefined) ? freq_waar_was_ik[value.waar_was_ik] = 1 : freq_waar_was_ik[value.waar_was_ik] += 1;
    }
    // Proportions 'Wat deed ik'
    if (value.wat_deed_ik == null) {
      0
    } else {
      (freq_wat_deed_ik[value.wat_deed_ik] == undefined) ? freq_wat_deed_ik[value.wat_deed_ik] = 1 : freq_wat_deed_ik[value.wat_deed_ik] += 1;
    }
    // Proportions 'Dagdeel'
    if (value.dagdeel == null) {
      0
    } else {
      (freq_dagdeel[value.dagdeel] == undefined) ? freq_dagdeel[value.dagdeel] = 1 : freq_dagdeel[value.dagdeel] += 1;
    }
    // Proportions 'Bijzonder'
    if (value.is_er_iets_bijzonders_gebeurd == null) {
      0
    } else {
      (freq_bijzonder[value.is_er_iets_bijzonders_gebeurd] == undefined) ? freq_bijzonder[value.is_er_iets_bijzonders_gebeurd] = 1 : freq_bijzonder[value.is_er_iets_bijzonders_gebeurd] += 1;
    }
    // Proportions 'Gezelschap'
    if (value.ik_was_het_afgelopen_dagdeel_grotendeels == null) {
      0
    } else {
      (freq_gezelschap[value.ik_was_het_afgelopen_dagdeel_grotendeels] == undefined) ? freq_gezelschap[value.ik_was_het_afgelopen_dagdeel_grotendeels] = 1 : freq_gezelschap[value.ik_was_het_afgelopen_dagdeel_grotendeels] += 1;
    }
    // Proportions 'Drukte'
    if (value.drukte == null) {
      0
    } else {
      (freq_drukte[value.drukte] == undefined) ? freq_drukte[value.drukte] = 1 : freq_drukte[value.drukte] += 1;
    }
    // Proportions 'Slaapduur'
    if (value.slaapduur == null) {
      0
    } else {
      (freq_slaapduur[value.slaapduur] == undefined) ? freq_slaapduur[value.slaapduur] = 1 : freq_slaapduur[value.slaapduur] += 1;
    }

    // Means 'Plezierigheid activiteit'
    if (value.plezierigheid_activiteit == null) {
      0
    } else {
      (means_plezierigheid_activiteit[value.wat_deed_ik] == undefined) ? means_plezierigheid_activiteit[value.wat_deed_ik] = +value.plezierigheid_activiteit : means_plezierigheid_activiteit[value.wat_deed_ik] += +value.plezierigheid_activiteit;
    }
    // Means 'Eigenwaarde'
    if (value.eigenwaarde == null) {
      0
    } else {
      (means_eigenwaarde[value.waar_was_ik] == undefined) ? means_eigenwaarde[value.waar_was_ik] = +value.eigenwaarde : means_eigenwaarde[value.waar_was_ik] += +value.eigenwaarde;
    }
    // Means 'Beweging'
    if (value.beweging == null) {
      0
    } else {
      (means_beweging[value.dagdeel] == undefined) ? means_beweging[value.dagdeel] = +value.beweging : means_beweging[value.dagdeel] += +value.beweging;
    }
    // Means 'Van Slag'
    if (value.ik_ben_van_slag == null) {
      0
    } else {
      (means_vanslag[value.is_er_iets_bijzonders_gebeurd] == undefined) ? means_vanslag[value.is_er_iets_bijzonders_gebeurd] = +value.ik_ben_van_slag : means_vanslag[value.is_er_iets_bijzonders_gebeurd] += +value.ik_ben_van_slag;
    }
    // Means 'Opgewektheid'
    if (value.opgewektheid == null) {
      0
    } else {
      (means_opgewektheid[value.drukte] == undefined) ? means_opgewektheid[value.drukte] = +value.opgewektheid : means_opgewektheid[value.drukte] += +value.opgewektheid;
    }
    // Means 'Tekort schieten'
    if (value.tekortschieten == null) {
      0
    } else {
      (means_tekort_schieten[value.drukte] == undefined) ? means_tekort_schieten[value.drukte] = +value.tekortschieten : means_tekort_schieten[value.drukte] += +value.tekortschieten;
    }
    // Means 'Opgewektheid dagritme'
    if (value.opgewektheid == null) {
      0
    } else {
      (means_opgewektheid_dagritme[value.dagdeel] == undefined) ? means_opgewektheid_dagritme[value.dagdeel] = +value.opgewektheid : means_opgewektheid_dagritme[value.dagdeel] += +value.opgewektheid;
    }
    // Means 'Ontspanning dagritme'
    if (value.ontspanning == null) {
      0
    } else {
      (means_ontspanning_dagritme[value.dagdeel] == undefined) ? means_ontspanning_dagritme[value.dagdeel] = +value.ontspanning : means_ontspanning_dagritme[value.dagdeel] += +value.ontspanning;
    }
    // Means 'Somberheid dagritme'
    if (value.somberheid == null) {
      0
    } else {
      (means_somberheid_dagritme[value.dagdeel] == undefined) ? means_somberheid_dagritme[value.dagdeel] = +value.somberheid : means_somberheid_dagritme[value.dagdeel] += +value.somberheid;
    }
    // Means 'Onrust dagritme'
    if (value.onrust == null) {
      0
    } else {
      (means_onrust_dagritme[value.dagdeel] == undefined) ? means_onrust_dagritme[value.dagdeel] = +value.onrust : means_onrust_dagritme[value.dagdeel] += +value.onrust;
    }
  });

  // Compute mean
  for (var mean in means_beweging) {
    means_beweging[mean] = means_beweging[mean] / freq_dagdeel[mean];
  } //mean == dagdeel
  for (var mean in means_vanslag) {
    means_vanslag[mean] = means_vanslag[mean] / freq_bijzonder[mean];
  }
  for (var mean in means_opgewektheid) {
    means_opgewektheid[mean] = means_opgewektheid[mean] / freq_drukte[mean];
  }
  for (var mean in means_tekort_schieten) {
    means_tekort_schieten[mean] = means_tekort_schieten[mean] / freq_drukte[mean];
  }
  for (var mean in means_opgewektheid_dagritme) {
    means_opgewektheid_dagritme[mean] = means_opgewektheid_dagritme[mean] / freq_dagdeel[mean];
  }
  for (var mean in means_ontspanning_dagritme) {
    means_ontspanning_dagritme[mean] = means_ontspanning_dagritme[mean] / freq_dagdeel[mean];
  }
  for (var mean in means_somberheid_dagritme) {
    means_somberheid_dagritme[mean] = means_somberheid_dagritme[mean] / freq_dagdeel[mean];
  }
  for (var mean in means_onrust_dagritme) {
    means_onrust_dagritme[mean] = means_onrust_dagritme[mean] / freq_dagdeel[mean];
  }
  ...
  data.forEach(function (value) {
    if (value.beweging == null) {
      ...
      (sd_beweging[value.dagdeel] == undefined) ? sd_beweging[value.dagdeel] = Math.pow(+value.beweging - means_beweging[value.dagdeel], 2) : sd_beweging[value.dagdeel] += Math.pow(+value.beweging - means_beweging[value.dagdeel], 2);
    }
    if (value.ik_ben_van_slag == null) {
      0
    } else {
      (sd_vanslag[value.is_er_iets_bijzonders_gebeurd] == undefined) ? sd_vanslag[value.is_er_iets_bijzonders_gebeurd] = Math.pow(+value.ik_ben_van_slag - means_vanslag[value.is_er_iets_bijzonders_gebeurd], 2) : sd_vanslag[value.is_er_iets_bijzonders_gebeurd] += Math.pow(+value.ik_ben_van_slag - means_vanslag[value.is_er_iets_bijzonders_gebeurd], 2);
    }
    if (value.opgewektheid == null) {
      0
    } else {
      (sd_opgewektheid[value.drukte] == undefined) ? sd_opgewektheid[value.drukte] = Math.pow(+value.opgewektheid - means_opgewektheid[value.drukte], 2) : sd_opgewektheid[value.drukte] += Math.pow(+value.opgewektheid - means_opgewektheid[value.drukte], 2);
    }
    if (value.tekortschieten == null) {
      0
    } else {
      (sd_tekort_schieten[value.drukte] == undefined) ? sd_tekort_schieten[value.drukte] = Math.pow(+value.tekortschieten - means_tekort_schieten[value.drukte], 2) : sd_tekort_schieten[value.drukte] += Math.pow(+value.tekortschieten - means_tekort_schieten[value.drukte], 2);
    }
    if (value.opgewektheid == null) {
      0
    } else {
      (sd_opgewektheid_dagritme[value.dagdeel] == undefined) ? sd_opgewektheid_dagritme[value.dagdeel] = Math.pow(+value.opgewektheid - means_opgewektheid_dagritme[value.dagdeel], 2) : sd_opgewektheid_dagritme[value.dagdeel] += Math.pow(+value.opgewektheid - means_opgewektheid_dagritme[value.dagdeel], 2);
    }
    if (value.ontspanning == null) {
      0
    } else {
      (sd_ontspanning_dagritme[value.dagdeel] == undefined) ? sd_ontspanning_dagritme[value.dagdeel] = Math.pow(+value.ontspanning - means_ontspanning_dagritme[value.dagdeel], 2) : sd_ontspanning_dagritme[value.dagdeel] += Math.pow(+value.ontspanning - means_ontspanning_dagritme[value.dagdeel], 2);
    }
    if (value.somberheid == null) {
      0
    } else {
      (sd_somberheid_dagritme[value.dagdeel] == undefined) ? sd_somberheid_dagritme[value.dagdeel] = Math.pow(+value.somberheid - means_somberheid_dagritme[value.dagdeel], 2) : sd_somberheid_dagritme[value.dagdeel] += Math.pow(+value.somberheid - means_somberheid_dagritme[value.dagdeel], 2);
    }
    if (value.onrust == null) {
      0
    } else {
      (sd_onrust_dagritme[value.dagdeel] == undefined) ? sd_onrust_dagritme[value.dagdeel] = Math.pow(+value.onrust - means_onrust_dagritme[value.dagdeel], 2) : sd_onrust_dagritme[value.dagdeel] += Math.pow(+value.onrust - means_onrust_dagritme[value.dagdeel], 2);
    }
  });


  for (var temp in sd_beweging) {
    sd_beweging[temp] = Math.sqrt(sd_beweging[temp] / freq_dagdeel[temp]);
  }
  for (var temp in sd_vanslag) {
    sd_vanslag[temp] = Math.sqrt(sd_vanslag[temp] / freq_bijzonder[temp]);
  }
  for (var temp in sd_opgewektheid) {
    sd_opgewektheid[temp] = Math.sqrt(sd_opgewektheid[temp] / freq_drukte[temp]);
  }
  for (var temp in sd_tekort_schieten) {
    sd_tekort_schieten[temp] = Math.sqrt(sd_tekort_schieten[temp] / freq_drukte[temp]);
  }
  for (var temp in sd_opgewektheid_dagritme) {
    sd_opgewektheid_dagritme[temp] = Math.sqrt(sd_opgewektheid_dagritme[temp] / freq_dagdeel[temp]);
  }
  for (var temp in sd_ontspanning_dagritme) {
    sd_ontspanning_dagritme[temp] = Math.sqrt(sd_ontspanning_dagritme[temp] / freq_dagdeel[temp]);
  }
  for (var temp in sd_somberheid_dagritme) {
    sd_somberheid_dagritme[temp] = Math.sqrt(sd_somberheid_dagritme[temp] / freq_dagdeel[temp]);
  }
  for (var temp in sd_onrust_dagritme) {
    sd_onrust_dagritme[temp] = Math.sqrt(sd_onrust_dagritme[temp] / freq_dagdeel[temp]);
  }
  ...
  for (var mean in means_plezierigheid_activiteit) {
    ...
    data_plezierigheid_activiteit.push({
      'activiteit': mean,
      'plezier': means_plezierigheid_activiteit[mean],
      'frequency': Math.log(freq_wat_deed_ik[mean])
    })
  }

  for (var mean in means_eigenwaarde) {
    means_eigenwaarde[mean] = means_eigenwaarde[mean] / freq_waar_was_ik[mean];
    data_eigenwaarde.push({
      'name': mean,
      'value': means_eigenwaarde[mean],
      'frequency': Math.log(freq_waar_was_ik[mean])
    })
  }
  ...
  for (var dagdeel in means_beweging) {
    data_beweging.push({
      'name': dagdeel,
      'value': means_beweging[dagdeel],
      'frequency': freq_dagdeel[dagdeel],
      'sd': sd_beweging[dagdeel]
    })
  }
  ...
  for (var mean in means_vanslag) {
    data_vanslag.push({
      'name': mean,
      'value': means_vanslag[mean],
      'frequency': freq_bijzonder[mean],
      'sd': sd_vanslag[mean]
    })
  }

  for (var mean in means_opgewektheid) {
    data_opgewektheid.push({
      'name': mean,
      'value': means_opgewektheid[mean],
      'frequency': freq_drukte[mean],
      'sd': sd_opgewektheid[mean]
    })
  }

  for (var mean in means_tekort_schieten) {
    data_tekort_schieten.push({
      'name': mean,
      'value': means_tekort_schieten[mean],
      'frequency': freq_drukte[mean],
      'sd': sd_tekort_schieten[mean]
    })
  }

  for (var mean in means_opgewektheid_dagritme) {
    data_positief_dagritme.push({
      'name': mean,
      'opgewektheid': means_opgewektheid_dagritme[mean],
      'ontspanning': means_ontspanning_dagritme[mean],
      'frequency': freq_dagdeel[mean],
      'sd_opgewektheid': sd_opgewektheid_dagritme[mean],
      'sd_ontspanning': sd_ontspanning_dagritme[mean]
    })
  }

  for (var mean in means_somberheid_dagritme) {
    data_negatief_dagritme.push({
      'name': mean,
      'somberheid': means_somberheid_dagritme[mean],
      'onrust': means_onrust_dagritme[mean],
      'frequency': freq_dagdeel[mean],
      'sd_somberheid': sd_somberheid_dagritme[mean],
      'sd_onrust': sd_onrust_dagritme[mean]
    })
  }
...
function render_histSlaap() {
  var histG = hgiHistogram().height(350).margin({
    top: 20,
    right: 50,
    bottom: 90,
    left: 50
  }).mapping(['datum', 'slaapkwaliteit']).yDomain([0, 100]).rotateXScale(true).yTicks(5).yLabel('Slaapkwaliteit');
...
function render_lineHoeGaatHet() {
  var plotLine = hgiLine().width(625).margin({
    'top': 20,
    'right': 130,
    'bottom': 40,
    'left': 50
  }).mapping(['meetmoment', 'uw_eigen_factor', 'hoe_gaat_het_met_u']).yDomain([0, 100]).legend(['Uw eigen factor', 'Hoe gaat het met u?']).yTicks(5).xLabel('Meetmoment');
