...
// Todo: this is all global, modularize this file.
var injectButtons,
    drawTable,
...
injectButtons = function (node_names) {
    injectSimulationFunctionality();
...
injectSimulationFunctionality = function () {
...
generateSelectOptions = function (from, to, stepsize, location) {
    html = $(location);
...
appendSelectOptions = function (data, location) {
    html = $(location);
...
clickNode = function (node_name_id, node_id) {
